...
return [
    ...
    'reserved' => 'Reserved',
    'reserved__placeholder' => 'Enter reserved here...',
    'access_token_with_bearer' => 'The access token prefixed with the "Bearer " key word.',
    'index_route_description' => 'Retrieve existing shops.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the shop property name where the value is the assigned value to the retrieved shop.',
    ...
    'show_route_description' => 'Retrieve existsing shop.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the shop to retrieve',
    'destroy_route_description' => 'Delete existsing shop.',
    ...
    'the_id_of_model_to_delete' => 'The id of the shop to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete shops.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the shop.',
    ...
    'the_requested_model_does_not_exists' => 'The requested shop does not exists.',
    ...
    'edit' => 'Edit Shop',
    'show' => 'Show Shop',
    'show_all' => 'Show All Shop',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Shop.',
    'none_available' => 'No Shops Available.',
    'model_plural' => 'Shops',
    'model_was_added' => 'Shop was successfully added.',
    'model_was_retrieved' => 'Shop was successfully retrieved.',
    'models_were_retrieved' => 'Shops were successfully retrieved.',
    'model_was_updated' => 'Shop was successfully updated.',
    'model_was_deleted' => 'Shop was successfully deleted.',
