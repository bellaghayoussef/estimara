...
return [
    ...
    'file' => 'File',
    'shop1' => 'Shop1',
    'shop1__placeholder' => 'Enter shop1 here...',
    'shop2' => 'Shop2',
    'shop2__placeholder' => 'Enter shop2 here...',
    'shop3' => 'Shop3',
    'shop3__placeholder' => 'Enter shop3 here...',
    'access_token_with_bearer' => 'The access token prefixed with the "Bearer " key word.',
    'index_route_description' => 'Retrieve existing demandes.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the demande property name where the value is the assigned value to the retrieved demande.',
    ...
    'show_route_description' => 'Retrieve existsing demande.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the demande to retrieve',
    'destroy_route_description' => 'Delete existsing demande.',
    ...
    'the_id_of_model_to_delete' => 'The id of the demande to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete demandes.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the demande.',
    ...
    'the_requested_model_does_not_exists' => 'The requested demande does not exists.',
    ...
    'create' => 'Create New Demande',
    'delete' => 'Delete Demande',
    'edit' => 'Edit Demande',
    'show' => 'Show Demande',
    'show_all' => 'Show All Demande',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Demande.',
    'none_available' => 'No Demandes Available.',
    'model_plural' => 'Demandes',
    'model_was_added' => 'Demande was successfully added.',
    'model_was_retrieved' => 'Demande was successfully retrieved.',
    'models_were_retrieved' => 'Demandes were successfully retrieved.',
    'model_was_updated' => 'Demande was successfully updated.',
    'model_was_deleted' => 'Demande was successfully deleted.',
