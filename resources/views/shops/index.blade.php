...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ trans('shops.model_plural') }}</h4>
            </div>
        ...
        @if(count($shops) == 0)
            <div class="panel-body text-center">
                <h4>{{ trans('shops.none_available') }}</h4>
            </div>
        @else
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('shops.shop.show', $shop->id ) }}" class="btn btn-info" title="{{ trans('shops.show') }}">
